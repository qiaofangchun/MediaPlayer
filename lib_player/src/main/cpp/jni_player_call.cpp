...
void JNIPlayerCall::onCallPrepared(ThreadMode mode) {
    if (mode == THREAD_MAIN) {
...
void JNIPlayerCall::onCallLoading(ThreadMode mode, bool loading) {
    if (mode == THREAD_MAIN) {
...
void JNIPlayerCall::onCallProgress(ThreadMode mode, int current, int total) {
    if (mode == THREAD_MAIN) {
...
void JNIPlayerCall::onCallError(ThreadMode mode, int errorCode, const char *errorMsg) {
    if (mode == THREAD_MAIN) {
...
void JNIPlayerCall::onCallComplete(ThreadMode mode) {
    if (mode == THREAD_MAIN) {
...
bool JNIPlayerCall::onCallIsSupportStiffCodec(ThreadMode mode, const char *codecName) {
    bool support = false;
...
void
JNIPlayerCall::onCallInitMediaCodec(ThreadMode mode, const char *mime, int width, int height,
